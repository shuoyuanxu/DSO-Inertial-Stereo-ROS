...
double setting_scaleResetLow = 0.1;
double setting_scaleResetHigh = 10;
double setting_stereoMaxDepth = 1e10;   // off by default

bool setting_carryStateOverReset = false;
Vec3 carried_bias_g = Vec3::Zero();
Vec3 carried_bias_a = Vec3::Zero();
double carried_scale = 1;
